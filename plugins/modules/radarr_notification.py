...
DOCUMENTATION = r'''
---
module: radarr_notification

short_description: Manages Radarr notification.

version_added: "1.0.0"

description: Manages Radarr notification.
...
def is_changed(status, want):
    if (want.name != status.name or
            ...
            want.on_movie_added != status.on_movie_added or
            want.on_movie_delete != status.on_movie_delete or
            want.on_movie_file_delete != status.on_movie_file_delete or
            want.on_movie_file_delete_for_upgrade != status.on_movie_file_delete_for_upgrade or
...
def init_module_args():
    ...
    return dict(
        ...
        on_movie_add=dict(type='bool', default=False),
        on_movie_delete=dict(type='bool', default=False),
        on_movie_file_delete=dict(type='bool', default=False),
        on_movie_file_delete_for_upgrade=dict(type='bool', default=False),
