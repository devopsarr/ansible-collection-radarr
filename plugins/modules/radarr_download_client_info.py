...
DOCUMENTATION = r'''
---
module: radarr_download_client_info

short_description: Get information about Radarr download client.

version_added: "1.0.0"

description: Get information about Radarr download client.
