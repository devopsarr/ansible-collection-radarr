...
DOCUMENTATION = r'''
---
module: radarr_metadata_schema_info

short_description: Get information about Radarr metadata schema.

version_added: "1.0.0"

description: Get information about Radarr metadata schema.
