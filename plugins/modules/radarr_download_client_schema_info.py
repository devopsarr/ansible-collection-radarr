...
DOCUMENTATION = r'''
---
module: radarr_download_client_schema_info

short_description: Get information about Radarr download client schema.

version_added: "1.0.0"

description: Get information about Radarr download client schema.
...
def run_module():
    ...
    client = radarr.DownloadClientApi(module.api)
    result = dict(
        changed=False,
        download_clients=[],
    )
