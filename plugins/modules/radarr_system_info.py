...
DOCUMENTATION = r'''
---
module: radarr_system_info

short_description: Radarr system info module

version_added: "0.0.1"

description: Provide Radarr system info
...
app_name:
    description: It should be Radarr.
    type: str
    returned: always
    sample: 'Radarr'
version:
