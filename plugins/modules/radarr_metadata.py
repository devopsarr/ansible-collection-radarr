...
DOCUMENTATION = r'''
---
module: radarr_metadata

short_description: Manages Radarr metadata.

version_added: "1.0.0"

description: Manages Radarr metadata.
...
config_contract:
    ...
    returned: always
    type: str
    sample: "MediaBrowserMetadataSettings"
implementation:
    description: Implementation.
    returned: always
    type: str
    sample: "MediaBrowserMetadata"
tags:
