...
DOCUMENTATION = r'''
---
module: radarr_release_profile_info

short_description: Get information about Radarr release profile.

version_added: "1.0.0"

description: Get information about Radarr release profile.
...
def run_module():
    ...
    client = radarr.ReleaseProfileApi(module.api)
    result = dict(
        changed=False,
        release_profiles=[],
    )
